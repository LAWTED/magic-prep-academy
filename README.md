...
This is an PWA Project, which means you can install it on your phone and use it full screen.
...
- Create a Student Account
    - you can use your email to sign up
- Create a Mentor Account
    - Click the button "For Mentors"
    - you can use your email to sign up

### Quiz

- Mentor generates a personalized game for you.
   Mentor can upload pdf, word or text file, and they are automatically “translated” into new mini-game modules, mentor can generate four kinds of quiz and instantly added to the mentee’s game tab (mentioned in 2a).
- Deal with the questions.
   Here we can see the quiz that mentor created just now. And there are 4 kinds of quiz:
   - Matching
   - Multiple choice
   - Fill in the blank
   - Dialogue
...
1. Every time you do a quiz, you need to use a heart.
    Click the heart button on the top right corner. You can buy some hearts in the shop. Currently, they are free.
   TODO: Refund the heart if user do it all right.

2. Every time you finish a module, you will get some XP.
   1. And you can use XP to buy something in the shop. Just click the money button on the top right corner.
   TODO: Decide XP earned by the correct answer.


## School & Program

1. You can filter the school and program you want to apply based on location and subject.
2. You can save the program as your target program.
3. You can see the summary of the program you want to apply to, it's generated by AI.
4. You can check your eligibility of the program you want to apply to.
